    ...
    <table width="700" cellpadding="8">
      <tr>
        ...
        <td valign="top">
          ...
          </dsp:droplet> <!-- foreach loop on artists -->
            
          <!-- if concert is of type fundraiser, display the organization
               for which it is raising funds -->
          ...
          <dsp:droplet name="/atg/dynamo/droplet/Switch">
           ...
           </dsp:droplet> <!-- switch on concert type -->
